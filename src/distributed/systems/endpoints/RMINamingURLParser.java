 ...
 */
public class RMINamingURLParser {
	...
	/**
	  ...
	  */
	public static EndPoint fromURL(String str)throws MalformedURLException{
		try {
	...
	private static EndPoint intParseURL(String str) throws MalformedURLException, URISyntaxException{
		URI uri = new URI(str);
		if (uri.isOpaque()) {
		...
		return new EndPoint(host, port, name);
	}
}
